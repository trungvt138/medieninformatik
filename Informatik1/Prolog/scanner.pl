 ...
 * Datei:            scanner.pl                *
 * Autor:            Kai von Luck              *
 * letzte Aenderung: 31.10.2018                *
 * von:              Sabine Schumann           *
 ***********************************************/
 
/* Convert bytestream into a List */
scanner(List):- read_sentence(List), !.
...
%terminal_symbol('.'). % nicht f�r unsere kleine Sprache, wegen 2.0
terminal_symbol('!').
terminal_symbol('?').
...
single_character(63).  /* ? */
single_character(33).  /* ! */
%single_character(46).  /* . */ % nicht f�r unsere kleine Sprache, wegen 2.0
...
in_word(39,39).                        /* ' */
in_word(45,45).                        /* - */
in_word(46,46).                        /* . */ % extra f�r unsere kleine Sprache, wegen 2.0